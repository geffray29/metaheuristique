...
if __name__ == '__main__':
    ...
    heuristique_sac_a_dos, voisinage, sol_init, proba_pertubation)
    

    x_heur, value_heur = heuristique_sac_a_dos(n, m, cost, a, b, '0')
    x_mont, value_monte = algorithme_montee(x_heur, a, b, cost, voisinage)
